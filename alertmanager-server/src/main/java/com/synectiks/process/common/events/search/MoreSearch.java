...
import com.synectiks.process.common.plugins.views.search.errors.EmptyParameterError;
...
public class MoreSearch {
    ...
    private String decorateQuery(Set<Parameter> queryParameters, TimeRange timeRange, String queryString) {
        ...
        com.synectiks.process.common.plugins.views.search.Search search = com.synectiks.process.common.plugins.views.search.Search.builder()
