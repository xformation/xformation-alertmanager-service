...
import com.synectiks.process.server.inputs.transports.netty.PromiseFailureHandler;
...
import com.synectiks.process.server.plugin.MetricSets;
...
import com.synectiks.process.server.plugin.inputs.util.PacketInformationDumper;
...
public abstract class NettyTransport implements Transport {
     ...
     * {@link com.synectiks.process.server.plugin.journal.RawMessage} for incoming messages at the end of the pipeline.
     *
