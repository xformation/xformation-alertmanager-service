    ...
    public static abstract class Position {
        ...
        public WidgetPositionDTO convert(Map<String, ValueReference> parameters) {
            return WidgetPositionDTO.Builder.create()
                    .col(com.synectiks.process.common.plugins.views.search.views.Position.fromInt(col().asInteger(parameters)))
                    .row(com.synectiks.process.common.plugins.views.search.views.Position.fromInt(row().asInteger(parameters)))
                    .height(com.synectiks.process.common.plugins.views.search.views.Position.fromInt(height().asInteger(parameters)))
                    .width(com.synectiks.process.common.plugins.views.search.views.Position.fromInt(width().asInteger(parameters)))
                    .build();
        }
    }
}
