...
public class PluginLoader {
    ...
    /**
     * Adapter for {@link com.synectiks.process.server.plugin.Plugin} which implements {@link #equals(Object)} and {@link #hashCode()}
     * only taking {@link com.synectiks.process.server.plugin.PluginMetaData#getUniqueId()} into account.
     */
