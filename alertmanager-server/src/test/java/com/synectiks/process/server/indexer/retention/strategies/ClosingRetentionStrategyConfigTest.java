...
public class ClosingRetentionStrategyConfigTest {
    ...
    public void testSerialization() throws JsonProcessingException {
        ...
        assertThat((String) JsonPath.read(document, "$.type")).isEqualTo("com.synectiks.process.server.indexer.retention.strategies.ClosingRetentionStrategyConfig");
    ...
    public void testDeserialization() throws IOException {
        final ObjectMapper objectMapper = new ObjectMapperProvider().get();
        final String json = "{ \"type\": \"com.synectiks.process.server.indexer.retention.strategies.ClosingRetentionStrategyConfig\", \"max_number_of_indices\": 25}";
