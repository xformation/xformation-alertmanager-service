...
public class SizeBasedRotationStrategyConfigTest {
    ...
    public void testSerialization() throws JsonProcessingException {
        ...
        assertThat((String) JsonPath.read(document, "$.type")).isEqualTo("com.synectiks.process.server.indexer.rotation.strategies.SizeBasedRotationStrategyConfig");
    ...
    public void testDeserialization() throws IOException {
        final ObjectMapper objectMapper = new ObjectMapperProvider().get();
        final String json = "{ \"type\": \"com.synectiks.process.server.indexer.rotation.strategies.SizeBasedRotationStrategyConfig\", \"max_size\": 1000 }";
