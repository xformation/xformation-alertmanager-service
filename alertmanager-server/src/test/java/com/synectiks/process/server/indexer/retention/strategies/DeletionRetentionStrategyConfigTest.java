...
public class DeletionRetentionStrategyConfigTest {
    ...
    public void testSerialization() throws JsonProcessingException {
        ...
        assertThat((String) JsonPath.read(document, "$.type")).isEqualTo("com.synectiks.process.server.indexer.retention.strategies.DeletionRetentionStrategyConfig");
    ...
    public void testDeserialization() throws IOException {
        final ObjectMapper objectMapper = new ObjectMapperProvider().get();
        final String json = "{ \"type\": \"com.synectiks.process.server.indexer.retention.strategies.DeletionRetentionStrategyConfig\", \"max_number_of_indices\": 23}";
